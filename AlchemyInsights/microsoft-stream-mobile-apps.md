...
Microsoft Stream on käytettävissä iOS- ja Android-mobiilisovelluksissa puhelimissa ja taulutietokoneissa, jotta voit katsoa videoita ollessasi matkalla.

- [Microsoft Stream -mobiilisovellukset](https://docs.microsoft.com/stream/mobile-apps-overview)
- [Hanki Microsoft Stream -mobiilisovellukset](https://docs.microsoft.com/stream/mobile-get-apps)
