...
ms.locfileid: "45205228"
---
# <a name="connect-to-exchange-online-powershell"></a>Yhteyden muodostaminen Exchange Online PowerShelliin

Lisätietoja PowerShellin käyttämisestä Exchange Onlinessa on ohjeaiheessa [Exchange Online PowerShellin käyttäminen nykyaikaisen todennuksen kanssa V2-moduulin avulla](https://aka.ms/exops-docs).
