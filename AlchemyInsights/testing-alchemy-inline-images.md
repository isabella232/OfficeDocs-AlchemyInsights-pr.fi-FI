...
---
# <a name="access-the-domains-page"></a>Toimialueet-sivun käyttäminen

Pääset toimialuesivulle napsauttamalla alla olevaa kuvaketta:
...
Tämän avulla voit lisätä, muokata tai poistaa toimialuettasi.
