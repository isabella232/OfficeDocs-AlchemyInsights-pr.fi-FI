...
---
# <a name="access-the-domains-page"></a><span data-ttu-id="ecb94-102">Toimi alueet-sivun käyttö</span><span class="sxs-lookup"><span data-stu-id="ecb94-102">Access the Domains Page</span></span>

<span data-ttu-id="ecb94-103">Pääset toimi alueet-sivulle napsauttamalla alla olevaa kuvaketta:</span><span class="sxs-lookup"><span data-stu-id="ecb94-103">To access the domains page, just click this icon below:</span></span>
...
<span data-ttu-id="ecb94-104">Tämän jälkeen voit lisätä, muokata tai poistaa toimi alueesi.</span><span class="sxs-lookup"><span data-stu-id="ecb94-104">Then you can add, modify, or remove your domain.</span></span>
<span data-ttu-id="ecb94-105">Lisä tietoja on [verkko tunnusten usein kysytyissä kysymyksissä.](https://docs.microsoft.com/office365/admin/setup/domains-faq)</span><span class="sxs-lookup"><span data-stu-id="ecb94-105">For more information, see the [Domains FAQ.](https://docs.microsoft.com/office365/admin/setup/domains-faq)</span></span>
