---
title: Alchemy-tekstiin sitoutuvien kuvien testaus
ms.author: pebaum
author: pebaum
ms.date: 04/21/2020
ms.audience: ITPro
...
ms.locfileid: "47669389"
---
# <a name="access-the-domains-page"></a><span data-ttu-id="5fef8-102">Toimi alueet-sivun käyttäminen</span><span class="sxs-lookup"><span data-stu-id="5fef8-102">Access the Domains Page</span></span>

<span data-ttu-id="5fef8-103">Pääset Domains (toimi alueet)-sivulle napsauttamalla seuraavaa kuvaketta:</span><span class="sxs-lookup"><span data-stu-id="5fef8-103">To access the domains page, just click this icon below:</span></span>
...
<span data-ttu-id="5fef8-104">Sen jälkeen voit lisätä, muokata tai poistaa toimi alueen.</span><span class="sxs-lookup"><span data-stu-id="5fef8-104">Then you can add, modify, or remove your domain.</span></span>
<span data-ttu-id="5fef8-105">Lisä tietoja on kohdassa [toimi alueiden usein kysytyt kysymykset.](https://docs.microsoft.com/microsoft-365/admin/setup/domains-faq)</span><span class="sxs-lookup"><span data-stu-id="5fef8-105">For more information, see the [Domains FAQ.](https://docs.microsoft.com/microsoft-365/admin/setup/domains-faq)</span></span>
