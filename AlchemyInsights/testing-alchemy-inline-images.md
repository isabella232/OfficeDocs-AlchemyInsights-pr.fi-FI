...
---
# <a name="access-the-domains-page"></a>Toimialueiden sivun käyttäminen

Pääset toimialueet-sivulle napsauttamalla alla olevaa kuvaketta:
...
Tämän illavoit lisätä, muokata tai poistaa toimialueen.
