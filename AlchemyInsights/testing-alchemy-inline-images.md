...
---
# <a name="access-the-domains-page"></a>Toimi alueet-sivun käyttäminen

Pääset Domains (toimi alueet)-sivulle napsauttamalla seuraavaa kuvaketta:
...
Sen jälkeen voit lisätä, muokata tai poistaa toimi alueen.
Lisä tietoja on kohdassa [toimi alueiden usein kysytyt kysymykset.](https://docs.microsoft.com/microsoft-365/admin/setup/domains-faq)
