...
ms.locfileid: "44505052"
---
# <a name="access-the-domains-page"></a><span data-ttu-id="a990e-102">Toimialueet-sivun käyttäminen</span><span class="sxs-lookup"><span data-stu-id="a990e-102">Access the Domains Page</span></span>

<span data-ttu-id="a990e-103">Pääset toimialuesivulle napsauttamalla alla olevaa kuvaketta:</span><span class="sxs-lookup"><span data-stu-id="a990e-103">To access the domains page, just click this icon below:</span></span>
...
<span data-ttu-id="a990e-104">Tämän avulla voit lisätä, muokata tai poistaa toimialuettasi.</span><span class="sxs-lookup"><span data-stu-id="a990e-104">Then you can add, modify, or remove your domain.</span></span>
<span data-ttu-id="a990e-105">Lisätietoja on [Toimialueiden usein kysytyissä kysymyksissä.](https://docs.microsoft.com/microsoft-365/admin/setup/domains-faq)</span><span class="sxs-lookup"><span data-stu-id="a990e-105">For more information, see the [Domains FAQ.](https://docs.microsoft.com/microsoft-365/admin/setup/domains-faq)</span></span>
