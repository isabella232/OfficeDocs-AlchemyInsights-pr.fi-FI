---
title: Alkemian inline-kuvien testaaminen
ms.author: pebaum
author: pebaum
ms.date: 04/21/2020
ms.audience: ITPro
...
ms.locfileid: "43759977"
---
# <a name="access-the-domains-page"></a><span data-ttu-id="f3aa2-102">Toimialueiden sivun käyttäminen</span><span class="sxs-lookup"><span data-stu-id="f3aa2-102">Access the Domains Page</span></span>

<span data-ttu-id="f3aa2-103">Pääset toimialueet-sivulle napsauttamalla alla olevaa kuvaketta:</span><span class="sxs-lookup"><span data-stu-id="f3aa2-103">To access the domains page, just click this icon below:</span></span>
...
<span data-ttu-id="f3aa2-104">Tämän illavoit lisätä, muokata tai poistaa toimialueen.</span><span class="sxs-lookup"><span data-stu-id="f3aa2-104">Then you can add, modify, or remove your domain.</span></span>
<span data-ttu-id="f3aa2-105">Lisätietoja on [Domainsin usein kysytyissä kysymyksissä.](https://docs.microsoft.com/office365/admin/setup/domains-faq)</span><span class="sxs-lookup"><span data-stu-id="f3aa2-105">For more information, see the [Domains FAQ.](https://docs.microsoft.com/office365/admin/setup/domains-faq)</span></span>
