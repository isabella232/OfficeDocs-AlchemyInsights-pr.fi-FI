...
- [Yhteyden muodostaminen Office 365:een PowerShellin avulla](https://docs.microsoft.com/office365/enterprise/powershell/connect-to-office-365-powershell#connect-with-the-microsoft-azure-active-directory-module-for-windows-powershell)
...
- [Yksittäisen käyttäjän salasanan määrittäminen niin, ettei se vanhene koskaan](https://docs.microsoft.com/microsoft-365/admin/add-users/set-password-to-never-expire)
