---
title: Yhteystietojen tuominen Outlook.comissa
ms.author: daeite
author: daeite
manager: joallard
ms.date: 04/21/2020
...
ms.locfileid: "53962200"
---
# <a name="import-contacts"></a>Yhteystietojen tuominen

Ennen kuin tuot yhteystietoja Outlook.comiin, sinun on vietävä ne toisilta sähköpostipalveluntarjoajaltasi .csv tiedostona. Noudata sitten alla olevia ohjeita.
...
.
2. Valitse sivun yläreunassa Hallitse **tuo** \> **yhteystietoja**.
3. Valitse **Selaa**, siirry kansioon, johon tallensit viedyt yhteystiedot, ja valitse **Avaa**.

Lisätietoja on kohdassa Yhteystietojen [tuominen Outlook.comiin.](https://support.office.com/article/285a3b55-8d93-4ac8-93df-43fffd13b2f1?wt.mc_id=Office_Outlook_com_Alchemy)
