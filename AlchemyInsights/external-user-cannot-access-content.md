...
---
# <a name="external-user-cannot-access-content"></a>Ulkoinen käyttäjä ei voi käyttää sisältöä

Jos ulkoinen käyttäjä on kutsuttu ja ei pysty käyttämään sisältöä, yritä vierailla alla olevissa linkeissä:
