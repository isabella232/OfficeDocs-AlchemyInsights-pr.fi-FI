...
- Microsoft 365 järjestelmänvalvojat voit ottaa tai kalenterin julkaisemisen ja organisaation kalenterin käytöstä. Lisätietoja [käyttöön kalenteri julkaistaan jotta käyttäjät voivat jakaa tietoja](https://support.office.com/article/EB432E21-AAF0-466B-BF85-CEFEC0C7C4FC) ja [jakaa kalentereita ulkoisten käyttäjien kanssa](https://support.office.com/article/FB00DD4E-2D5F-4E8D-8FF4-94B2CF002BDD).
