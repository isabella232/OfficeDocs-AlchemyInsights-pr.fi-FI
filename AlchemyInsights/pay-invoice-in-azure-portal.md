...
1. Kun maksu tapa on valittu, valitse **maksa nyt**.
Laskun tilaksi päivitetään laskujen Blade-kohdassa.

**Suositellut asia kirjat**

- [Microsoft Azuren laskun maksaminen](https://docs.microsoft.com/azure/cost-management-billing/understand/pay-bill)
