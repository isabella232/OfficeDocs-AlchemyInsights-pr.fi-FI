...
Tutustu valittavissa oleviin vaihtoehtoihin käynnistämättä siirto on [päättää siirron polku](https://docs.microsoft.com/Exchange/mailbox-migration/decide-on-a-migration-path).
