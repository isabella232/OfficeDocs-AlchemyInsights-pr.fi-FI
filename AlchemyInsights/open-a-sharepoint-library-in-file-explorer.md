...
---
# <a name="open-a-sharepoint-library-in-file-explorer"></a>Avaa SharePoint-kirjaston tiedoston Resurssienhallinnassa

1. Siirry Internet Explorer 10 tai 11 Internet Explorerin kirjastoon. 
    
2. Napsauta Näytä-kuvaketta oikeassa yläkulmassa ja valitse sitten **Resurssienhallinta-näkymässä**.
