...
Luo käyttäjätilit ja lisää toimialueesi. Varmista, että käyttäjällä on [käyttöoikeudet](https://docs.microsoft.com/office365/admin/subscriptions-and-billing/assign-licenses-to-users).
