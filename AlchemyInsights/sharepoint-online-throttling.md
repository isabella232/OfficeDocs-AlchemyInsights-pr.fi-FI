...
SharePoint Online käyttää rajoittamista SharePoint Online -palvelun optimaalisen suorituskyvyn ja luotettavuuden ylläpitämiseen. Rajoittaminen rajoittaa käyttäjien toimien tai samanaikaisten kutsujen määrää (komentosarjojen tai koodin avulla), jotta resurssien liikakäyttö estetään. Jos saat kuristettu, 99% ajasta se johtuu mukautetun koodin.
  
Lisä tietoja käytön rajoittamisesta on Ohje aiheessa [SharePoint Onlinessa ei saa estää tai estää](https://go.microsoft.com/fwlink/?linkid=2022019) .
