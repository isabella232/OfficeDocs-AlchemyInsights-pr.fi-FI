...
Kuitenkin jos käyttäjä on pyydetään kirjautumaan **sisään**, voit määrittää Office-ne on työssään Kirjaudu tai koulu, jonka tulisi olla jo [määritetty Office-käyttöoikeus](https://docs.microsoft.com/office365/admin/subscriptions-and-billing/assign-licenses-to-users)asiakas.
