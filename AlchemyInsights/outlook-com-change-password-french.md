...
---
# <a name="changer-votre-mot-de-passe-dans-outlookcom"></a>Vaihtaja votre mot de passe dans Outlook.com
...
2. Par mesure de sécurité, vous pouvez être invité à confirmer votre identre identité à l'aide d'un code de sécurité.
3. Entrez votre mot de passe actuel, votre nouveau mot de passe, puis sélectionnez **Enregistrer**.

Si vous avez oublié votre mot de passe, accédez à la [page de réinitialisation de mot de passe de compte Microsoft](https://go.microsoft.com/fwlink/p/?linkid=841909), puis suivez les kutsuu.
