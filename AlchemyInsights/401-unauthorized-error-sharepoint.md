...
---
# <a name="401-unauthorized-error-in-sharepoint"></a>401:n luvaton virhe SharePointissa

Jos saat SharePointissa virheilmoituksen "(401) Unauthorized" ((401) Se saattaa olla liittyvä TLS 1.0/1.1 -käyttökoodin käytöstä poistoon. Lisätietoja: 
