...
Lisätietoja SharePointin ja OneDriven kestosta on kohdassa:

- [SharePointin ja OneDriven tietojen joustava käyttö Microsoft 365:ssä](https://docs.microsoft.com/compliance/assurance/assurance-sharepoint-onedrive-data-resiliency)
