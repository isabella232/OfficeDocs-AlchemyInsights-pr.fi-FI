...
ms.locfileid: "50481662"
---
# <a name="set-up-an-email-signature-in-outlook-for-ios"></a>Sähköpostin allekirjoituksen määrittäminen Outlook for iOS:ssä

Internetissä on paljon hyviä resursseja, jotka selittävät tämän. Hae Internetistä hakusanalla " Sähköpostin allekirjoituksen määrittäminen Outlook for iOS:ssä"