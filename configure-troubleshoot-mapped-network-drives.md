...
Kirjaston yhdistäminen verkko asemiksi on väliaikaista, ja sitä tuetaan vain Internet Explorerin avulla. Synkronoi sen sijaan [SharePoint-tiedostot uudella OneDrive-synkronointi ohjelmalla](https://support.office.com/article/6de9ede8-5b6e-4503-80b2-6190f3354a88) , joka tarjoaa [tiedostot](https://support.office.com/article/0e6860d3-d9f3-4971-b321-7092438fb38e)pyydettäessä. Käyttää kaikkia tiedostojasi OneDrivessa ilman paikallista tallennus tilaa.

* [SharePoint Onlineen yhdistettyihin verkko asemiin liittyviä ongelmia](https://docs.microsoft.com/sharepoint/support/administration/troubleshoot-mapped-network-drives)